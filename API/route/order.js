...
const { veriftyToken, veriftyTokenAndAuthorization,veriftyTokenAndAdmin } = require("./verifyToken");

const router = require("express").Router();

//create

router.post("/",veriftyToken ,async(req,res)=>{
...
//get user order id
router.get("/find/:userId", veriftyTokenAndAuthorization, async (req,res)=>{
  try{
